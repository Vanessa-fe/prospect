...
import { createStatus, updateStatus } from '@/lib/actions/statuses'
...
export function StatusFormDialog({ status, trigger }: StatusFormDialogProps) {
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {status
                ...
                : 'Créez un nouveau statut pour vos contacts'}
            </DialogDescription>
          </DialogHeader>
